...
const PARTENAIRES = [
  { nom:"Ministère du Commerce",                type:"Institution d'État",       contribution:"Fournit les données officielles d'immatriculation et de registre du commerce du Burkina Faso.", badge:"Données certifiées",     icone:"", ordre:1 },
  ...
  { nom:"Direction Générale des Douanes",       type:"Administration douanière", contribution:"Fournit les données d'import/export et certifie les activités commerciales transfrontalères.", badge:"Commerce certifié",      icone:"", ordre:7 },
  { nom:"CNSS — Caisse Nationale de Sécurité Sociale", type:"Sécurité sociale", contribution:"Certifie les données d'effectifs et la couverture sociale des employés des entreprises.",       badge:"Emploi vérifié",         icone:"", ordre:8 },
